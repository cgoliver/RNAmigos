...
parser.add_argument('-ad','--attributor_dims', nargs='*', help='Dimensions for attributor.', default=[128,64,32])
parser.add_argument('-ed','--embedding_dims', nargs='+', help='Dimensions for embeddings.', default=[128,128,128,128,128,128])
parser.add_argument('-mn','--motif_norm', nargs='+', help='Normalize motif embeddings.', default=False)
